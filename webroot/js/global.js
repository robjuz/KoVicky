$(document).ready(function(){
	...
	//adjust the same height to all thumbnails
	var maxThumbnailHeight = 0;
	$('.thumbnail').each(function(key, value){
		value = $(value);
		if (value.height() > maxThumbnailHeight) {
			maxThumbnailHeight = value.height();
		}
	}).each(function(key, value){
		$(value).height(maxThumbnailHeight);
	});
